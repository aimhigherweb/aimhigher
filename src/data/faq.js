...
const accordion = [
    ...
    },
    {
        ...
        slug: 'time-frame',
        content: (
            <p>This depends on the complexity of your site and how much you have to start with. On average, time to launch is between a week and a month.</p>
        ),
    },
    {
    ...
    },
    {
        ...
        slug: 'ecommerce',
        content: (
            <p>Yes, we can!. We build online stores that can accept a variety of payment methods such as PayPal, Direct Deposit and Credit Card. We can also integrate anywhere else you're selling things, such as Etsy.</p>
        ),
    },
    {
        ...
        slug: 'content',
        content: (
            <p>One of the services we offer is content research, writing and editing. We have a professional writer who will research similar websites and write high quality content for your site. Alternatively, they can just edit and expand on any existing content that you may already have.</p>
        ),
    },
    {
