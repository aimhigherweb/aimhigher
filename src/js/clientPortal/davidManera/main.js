...
//Resources
import '../../../scss/clientPortal/davidManera/styles.scss';

class Meta extends Component {
    render() {
        let name = 'David Manera - Client Information';
        let description ="Don't look through emails, it's all here";
        let slug = 'david-manera';
...
export class DavidManera extends Component {
    render() {
        document.getElementById('root').classList.add('style-guide');

        return (
            <div className="content typography davidManera">
                <Meta />
                <h1>David Manera</h1>
                <div>
                    <StyleGuide />
