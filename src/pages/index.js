	...
	render() {
		return (
			<Layout meta={meta} wave>
				...
				<HomeContent>
					<p>
						AimHigher Web Design is based in Perth and helps
						businesses all over Australia in developing an online
						presence.
					</p>
					<ContentSVG>
						<ComputerCoffee />
					...
					<p>
						We specialise in building modern and professional
						websites that can be easily maintained by anyone,
						regardless of their technical skill.
					</p>
					<p>
						AimHigher Web Design also provide prompt and efficient
						Aftersale support to keep your website working for you,
						while you get on with business.
					</p>
					<ContentSVG>
						<MultipleHands />
					</ContentSVG>
