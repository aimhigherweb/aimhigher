...
export const Site = styled('div')`
	...
	min-width: 350px;
	max-width: calc(
		${(props) => props.sizes.width.desk} +
			${(props) => props.sizes.width.tab}
	);
	...
	${Tablet} {
		...
		--height-image: calc(
			${(props) => props.sizes.width.tabImg} *
				${(props) => props.sizes.ratio.tab}
		);
	...
	${Mobile} {
		...
		--height-image: calc(
			${(props) => props.sizes.width.mobImg} *
				${(props) => props.sizes.ratio.mob}
		);
